...
export default function Atroop() {
  ...
  function sendSection2WhatsApp(formData) {
    const data = Object.fromEntries(formData);
    console.log(data);
    const text = `סוללה א - עמדות:
  שם: ${data.name_shomer}
  עמדה: ${data.emda}
  צ' משקפת: ${data.mishkefet}
  צ' אמרל: ${data.nightvision}`;
    ...
    <section className="troop-container atroop-container">
      ...
      <Tabs>
        ...
        <div className="section-2" title="עמדות">
          <form action={sendSection2WhatsApp} className="section-2 form">
            <div className="input-container">
              <label htmlFor="name_shomer" className="label" title="שם שומר">
                שם:
              </label>
              <input
                type="text"
            ...
            <div className="input-container">
              <label htmlFor="emda" className="label" title="שם עמדה">
                עמדה:
              </label>
              <select
                name="emda"
            ...
            <div className="input-container">
              <label htmlFor="mishkefet" className="label" title="בחירת משקפת">
                צ' משקפת:
              </label>
              <select
                name="mishkefet"
        ...
        <div className="section-3" title="מיקומים">
          {dynamicInputs.map((input, index) => (
            <div className="input-container-1" key={index}>
              <label className="label" title={`מיקום ${input.label}`}>
                {input.label}:
              </label>
              <input
                type="text"
        ...
        <div className="section-4" title="מפקדי משימות">
          <Shifts />
        </div>
      </Tabs>
    </section>
